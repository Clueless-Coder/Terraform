...
variable "autoscale_thresholds" {
  ...
  default = {
    # Supporting thresholds as berow  #cpu_reservation_high    = // e.g. 75  #cpu_reservation_low     = // e.g.  5  #memory_reservation_high = // e.g. 75  #memory_reservation_low  = // e.g. 40
  }
}
...
variable "vpc_name" {
  type        = "string"
  description = "name of the vpc for environemnt"
}
...
/*variable "arx-admin-webapp-public-ip" {
  description = "IP address of the arx-admin-webapp which needs to be whitelisted"
}
*/
variable "nginxsg" {
